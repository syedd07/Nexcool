          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                PO Box 122281, Gulf Plaza, Madinah Road, Jeddah-23218-2163, KSA
                <br />
                ...
                <li>
                <a href="tel:+966560700103" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:support@example.com" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              ...
              <a
                href="https://www.linkedin.com/company/al-nourain"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium ">
              &copy; {year}. All rights reserved by <a href="https://nouraain.ae" target="_blankk">Al-Nourain.</a> 
            </p>
